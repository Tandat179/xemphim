...
class UserController {
   ...
   register = async (req, res, next) => {
      try {
         // User not Post Image of User Auto Image.
         if (!req.body.avatar) {
            req.body.avatar =
         ...
         //Create variable myCloud use Image manager some Propotive
   ...
   updateProfile = async (req, res, next) => {
      try {
         ...
         //Update Image and Upload Cloundinary
         if (req.body.avatar !== '') {
